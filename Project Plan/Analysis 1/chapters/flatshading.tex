...
%     \includegraphics[width=\linewidth]{flat.png}
  ...
  \endminipage
  \end{figure}
  Coloring vertex areas looking if the value of \textit{Gaussian curvature} is positive or negative will mark every change of signs highlighting the 3-dimensionality of the model.
