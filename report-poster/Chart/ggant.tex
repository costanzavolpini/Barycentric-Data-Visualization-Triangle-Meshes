...
\begin{landscape}
  ...
  \ganttbar[
    progress=100,
    bar/.append style={fill=black!43}
  ]{Fix some problems in \ganttalignnewline Gaussian curvature}{12.5.2018}{20.5.2018} \ganttnewline
  \ganttbar[
    progress=60,
    bar/.append style={fill=black!43}
  ]{Mean curvature per edges}{9.5.2018}{20.5.2018} \ganttnewline
  \ganttbar[]{Mean curvature (meshlab version)}{21.5.2018}{28.5.2018} \ganttnewline
  \ganttbar{Evaluation and comparison about\ganttalignnewline the extension of Gouraud Shading }{20.5.2018}{30.5.2018} \ganttnewline
  \ganttbar[
    progress=30,
    bar/.append style={fill=black!43}
  ]{Write the final report}{14.5.2018}{30.5.2018}
  \ganttbar[
    progress=100,
    bar/.append style={fill=black!43}
  ]{}{23.4.2018}{26.4.2018}
  \ganttnewline
  \ganttbar{Make the poster}{21.5.2018}{30.5.2018}
