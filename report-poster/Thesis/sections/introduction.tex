...
angle between the normals of adjacent triangles $T_1$ and $T_2$ with positive or negative sign is denoted as ${\theta}_E$.}\label{fig:mean-curvature}
\end{figure}
