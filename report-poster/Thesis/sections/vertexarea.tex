...
\begin{figure}[!h]
    ...
    \endminipage
    \caption{Comparison between: triangle flat shading, triangle Gouraud shading and vertex flat shading.}\caption{fig:comparison-icosahedron}
\end{figure}
...
\begin{figure}[!h]
    ...
    \scalebox{0.65}{\begin{tikzpicture}
        ...
        \end{scope}
    \end{tikzpicture}}
    \caption{On the left: angle defect is denoted with $\theta_j$.}
\end{figure}
%%
