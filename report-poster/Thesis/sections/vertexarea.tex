...
In Fig. \ref{fig:gc-detail} each vertex area is colored applying the \textit{max diagram} algorithm. Instead, in Fig. \ref{fig:gci-detail} the color is obtained with a linear interpolation.
